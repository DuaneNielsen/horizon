...
def main(args):
    ...
    if path.exists(folder_name):
        ...
        sys.stderr.write("The output folder %s already exists. Deleting.\n" % folder_name)
    ...
    # Create a source GstBin to abstract this bin's content from the rest of the
    # pipeline
    source_bin = Gst.Bin.new("source-bin-%02d" % 0)
    uri_decode_bin = Gst.ElementFactory.make("uridecodebin", "uri-decode-bin")
    ...
    sinkpad = streammux.get_request_pad("sink_%u" % 0)
