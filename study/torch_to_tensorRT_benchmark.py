...
detections_batch = model(torch.randn(64, 3, 224, 224).to("cuda"))
...
trt_model = torch2trt(model.eval(), [x], fp16_mode=True, strict_type_constraints=True, log_level=trt.Logger.INFO)
